...
// GA script injection removed for MV3 offscreen compatibility
var M=null;
var B=null;
var G=null;
...
f:s.frequency.value,g:s.gain.value,q:s.Q.value}
)}
B.connect(G);
function u(e){
f=V[e.index];
...
f:f.frequency.value,g:f.gain.value,q:f.Q.value}
);
o()}
function g(e){
if(e>10){
...
a++){
u({
index:a,frequency:t[a],gain:n[a],q:r[a]}
)}
E()}
)}
function b(t, e){
...
function _(){
var e={
type:"sendWorkspaceStatus",eqFilters:[],streams:[],gain:G.gain.value}
;
for(var t=0;
t<V.length;
t++){
var n=V[t];
e.eqFilters.push({
frequency:n.frequency.value,gain:n.gain.value,type:n.type,q:n.Q.value}
)}
for(var r in Y){
var a=Y[r].tab;
...
type:"sendSampleRate",Fs:M.sampleRate}
)}
function O(){
ee(function(e){
chrome.runtime.sendMessage({
type:"sendPresets",presets:e}
)}
)}
function E(){
w();
...
N(function(e){
chrome.runtime.sendMessage({
type:"sendCurrentTabStatus",streaming:e.id in Y}
)}
)}
function T(e,t,n){
if(!e){
...
e++){
u({
index:e,gain:0,frequency:z[e],q:H[e]}
)}
y({
gain:1}
);
...
delete n}
ee(function(e){
t("goatEQ_Presets.json",JSON.stringify(e,null,2))}
)}
$=function(e,t,n){
if (e.type === "pingOffscreen") {
    n({ alive: true });
    return;
}
if (e.type === "startCaptureOffscreen") {
...
if (e.type === "stopCaptureOffscreen") {
    j();
}
